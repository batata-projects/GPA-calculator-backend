...
class TestAvailableCourseRouter:
    def test_get_available_course_by_id(self, available_courses: list[AvailableCourse]):
        ...
        available_course_router = available_courses_router.AvailableCourseRouter(
            available_course_dao
        )
        assert (
            available_course_router.get_available_course_by_id(available_course.id)
            == available_course
        )
